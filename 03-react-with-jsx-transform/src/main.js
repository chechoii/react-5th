...
function AvatarPage() {
    return (React.createElement("ul", { className: "avatarList" },
        React.createElement(Avatar, { name: "a", status: "offline" }),
        React.createElement(Avatar, { name: "b", status: "disturb" }),
        React.createElement(Avatar, { name: "c", status: "await" }),
        React.createElement(Avatar, { name: "a", status: "online" }),
        React.createElement(Avatar, { name: "b", status: "online" })));
}
